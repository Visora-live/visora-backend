...
def create_identification(payload: IdentificationCreate, db: Session = Depends(get_db)):
...
def delete_identification(identification_id: int, db: Session = Depends(get_db)):
